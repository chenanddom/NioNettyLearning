 ...
 * Integer.MAX VALUE 。
 */
public class ChannelFileAreasMappedToMemoryReadWriteModeTest {
    public static void main(String[] args) throws IOException, InterruptedException {
        File file = new File("./ChannelFileAreasMappedToMemoryReadWriteModeDemo.txt");
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, "rw");
        FileChannel accessFileChannel = randomAccessFile.getChannel();
        MappedByteBuffer byteBuffer = accessFileChannel.map(FileChannel.MapMode.READ_WRITE, 0, 5);
