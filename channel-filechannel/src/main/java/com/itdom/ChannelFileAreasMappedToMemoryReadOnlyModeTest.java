 ...
 * Integer.MAX VALUE 。
 */
public class ChannelFileAreasMappedToMemoryReadOnlyModeTest {
    public static void main(String[] args) throws IOException, InterruptedException {
         ...
         * 	at java.nio.DirectByteBufferR.putChar(DirectByteBufferR.java:527)
         * 	at com.itdom.ChannelFileAreasMappedToMemoryReadOnlyModeTest.main(ChannelFileAreasMappedToMemoryReadOnlyModeTest.java:46)
         */
    }
}
