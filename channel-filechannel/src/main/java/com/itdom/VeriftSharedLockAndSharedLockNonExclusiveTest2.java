 ...
 */
public class VeriftSharedLockAndSharedLockNonExclusiveTest2 {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("end get the lock");
        /**
         * 先执行了程序VeriftSharedLockAndSharedLockNonExclusiveTest再执行VeriftSharedLockAndSharedLockNonExclusiveTest2
         * 执行结果end get the lock
         */
    }
}
